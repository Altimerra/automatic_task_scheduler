    ...
    createElement: function(element) {
        ...
        <li class="list-group-item d-flex" id="something">   
            ...
            <span>
                ...
                <button type="button" class="btn btn-danger btn-sm btn-xs"><span class="material-icons">close</span></button>
            </span>
        </li>
        */
       ...
       closeButton.addEventListener("click", handleTasklistClose)
